...
<MetaResultFile version="20211011" creator="Solver HFTD - Field 3DFD Monitor">
  ...
  <SpecialMaterials>
    ...
    <Material name="Antena(PCB1)/Copper" type="FIELDFREE"/>
    <Material name="Antena(PCB1)/VIAS_MATERIAL" type="FIELDFREE"/>
    <Material name="Antena_0(PCB1)/Copper" type="FIELDFREE"/>
