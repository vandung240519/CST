...
result=s:0
user_delete=s:1
treepath=s:Antena.log
files=s:..\Model\3D\Antena.log
...
lifetime=s:persistent
result=s:0
treepath=s:1D Results\Materials\Antena(PCB1)\Copper\Surface Impedance\Z' (Theory)
...
lifetime=s:persistent
result=s:0
treepath=s:1D Results\Materials\Antena(PCB1)\VIAS_MATERIAL\Surface Impedance\Z' (Theory)
...
result=s:1
user_delete=s:1
treepath=s:2D/3D Results\Current Density\current-density (f=2.45) [1]
files=s:current-density (f=2.45)_1,1.m3d
files=s:current-density (f=2.45)_1.rex
